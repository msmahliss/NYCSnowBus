<?php
  ...
  class jQueryConfig {
    public $subdomain = 'nycbeachbus';                // Your Wufoo username. If when logged into Wufoo the domain is example.wufoo.com, put "example" here
    public $apiKey = '7ZRQ-QX4Y-GS5Y-8PGF';        // XXXXX-XXXX-XXXX-XXXX   - From the Entry Manager, click Code button for any form then click API Information button
